export default class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        facil.on('pointerdown', pointer => {
            this.scene.start('level', { fuelNeeded: 2, meteorCooldown: 2000, score: 0, totalScore: 0, playerLives: -1 });
        });
        ...
        intermedio.on('pointerdown', pointer => {
            this.scene.start('level', { fuelNeeded: 3, meteorCooldown: 1000, score: 0, totalScore: 0, playerLives: -1 });
        });
        ...
        dificil.on('pointerdown', pointer => {
            this.scene.start('level', { fuelNeeded: 5, meteorCooldown: 500, score: 0, totalScore: 0, playerLives: -1 });
        });
    }
}